...
int counter_channel_2;
int counter_channel_3;
int counter_channel_4;
int loop_counter;

int esc_1, esc_2, esc_3, esc_4;
int throttle, battery_voltage;
int cal_int, start, gyro_address, temperature;
int receiver_input[5], acc_axis[4], gyro_axis[4];

float roll_level_adjust, pitch_level_adjust;

long acc_x, acc_y, acc_z, acc_total_vector;

unsigned long timer_channel_1, timer_1;
unsigned long timer_channel_2, timer_2;
unsigned long timer_channel_3, timer_3;
unsigned long timer_channel_4, timer_4;
unsigned long current_time, esc_timer, esc_loop_timer, loop_timer;
...
void setup(){
  ...
  battery_voltage = ((float)analogRead(0) * 1.466) + 10;
